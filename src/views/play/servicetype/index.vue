    ...
    >
      ...
      <el-form-item>
        ...
        <el-button
          ...
          v-hasPermi="['play:service-type:create']"
        >
        ...
        <el-button
          ...
          v-hasPermi="['play:service-type:export']"
        >
      ...
      <el-table-column label="操作" align="center" min-width="120px">
        <template #default="scope">
          <el-button
            ...
            v-hasPermi="['play:service-type:update']"
          >
            编辑
          </el-button>
          <el-button
            ...
            v-hasPermi="['play:service-type:delete']"
          >
            删除
          </el-button>
        </template>
...
const list = ref<ServiceTypeVO[]>([]) // 列表的数据
...
const handleExport = async () => {
  try {
    ...
    const data = await ServiceTypeApi.exportServiceType(queryParams)
    download.excel(data, '陪玩服务类型.xls')
  } catch {
  } finally {
